...
const niveauxData = {
  // Format: [débutant, intermédiaire, confirmé]
  // 30s efforts
  '30s':    {reps:['6×','10×','14×'], recup:['2min','1min30','1min'], allure:['allure vive contrôlée','allure Z4 soutenue','allure VMA proche']},
  '1min':   {reps:['6×','10×','14×'], recup:['2min','1min45','1min30'], allure:['effort perçu 7/10','85-90% FCmax','88-93% FCmax']},
  '1min30': {reps:['5×','8×','12×'], recup:['3min','2min','1min45'], allure:['effort soutenu contrôlé','85-90% FCmax','90-95% FCmax']},
  '2min':   {reps:['4×','6×','10×'], recup:['3min','2min30','2min'], allure:['effort gérable','85-90% FCmax','90-93% FCmax']},
  '3min':   {reps:['3×','5×','8×'],  recup:['4min','3min','2min30'], allure:['allure seuil doux','80-85% FCmax','85-90% FCmax']},
  '5min':   {reps:['2×','4×','6×'],  recup:['4min','3min30','3min'], allure:['allure seuil','80-85% FCmax','85-88% FCmax']},
  '6min':   {reps:['2×','3×','5×'],  recup:['4min','3min30','3min'], allure:['allure seuil confort','80-83% FCmax','83-87% FCmax']},
  '8min':   {reps:['2×','3×','4×'],  recup:['5min','4min','3min30'], allure:['allure semi débutant','allure cible course','légèrement sous allure course']},
  '10min':  {reps:['1×','2×','3×'],  recup:['5min','5min','4min'],   allure:['footing soutenu','allure seuil','allure seuil+']},
  '12min':  {reps:['1×','2×','3×'],  recup:['—','5min','4min'],      allure:['pas recommandé - faire 2×5min','allure seuil','allure seuil+']},
  '15min':  {reps:['1×','2×','2×'],  recup:['—','5min','4min'],      allure:['pas recommandé','allure seuil','allure seuil']},
  '20min':  {reps:['1×','1×','2×'],  recup:['—','—','5min'],         allure:['footing soutenu 20min','allure EF rapide','allure seuil']},
  'cote':   {reps:['6×','10×','14×'],recup:['descente marchée','descente trottinée','descente rapide'], allure:['effort 7/10','effort 8/10','effort 9/10']},
  'fartlek':{reps:['30min','45min','60min'],recup:['libre','structuré','intensif'], allure:['accélérations libres modérées','Z3-Z4 dans les montées','Z4-Z5 intensif']},
  '3030':   {reps:['6×','10×','15×'],recup:['30s récup','30s récup','30s récup'], allure:['allure 5km+','allure VMA -10%','allure VMA']},
}
